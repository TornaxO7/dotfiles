...
in
{
  ...
  services.traefik = {
    dynamicConfigOptions = {
      tcp.serversTransports.stalwart.proxyProtocol = { };
    };
  ...
  virtualisation.oci-containers.containers = {
    ...
    stalwart = {
      ...
      labels = {
        ...
        "traefik.tcp.services.${services.smtp}.loadbalancer.serversTransport" = "stalwart@file";
        ...
        "traefik.tcp.services.${services.smtps}.loadbalancer.serversTransport" = "stalwart@file";
        ...
        "traefik.tcp.services.${services.jmaps}.loadbalancer.serversTransport" = "stalwart@file";
